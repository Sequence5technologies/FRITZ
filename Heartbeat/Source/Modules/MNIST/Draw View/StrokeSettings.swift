...
open class StrokeSettings: NSObject {
    ...
    /// Color of the brush
    private static let defaultColor = CIColor(color: .black)
    ...
    required public convenience init?(coder aDecoder: NSCoder) {
        ...
        let width = aDecoder.decodeObject(forKey: StrokeSettings.widthKey) as? CGFloat ?? StrokeSettings.defaultWidth
